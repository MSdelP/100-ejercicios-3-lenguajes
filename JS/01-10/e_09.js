...
for (let numero = 11; numero <= 20; numero += 2) {
    console.log(numero);
}
...
// En la versión con for, se utiliza una declaración for para controlar la iteración y se incrementa numero por 2 en cada paso. 
