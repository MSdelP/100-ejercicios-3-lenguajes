...
print("Tipo de x antes de la conversión:", type(x))
print("Tipo de y antes de la conversión:", type(y))
...
print("Tipo de x después de la conversión:", type(x))
print("Tipo de y después de la conversión:", type(y))
